...
public class ArtworkAdapter extends ArrayAdapter<Artwork>
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		if (convertView == null)
		{
			convertView = LayoutInflater.from(context).inflate(R.layout.artwork_list_item, parent, false);
		}

		Artwork artwork = artworks.get(position);

		TextView titleView = convertView.findViewById(R.id.bp_title_text);
		TextView artistView = convertView.findViewById(R.id.bp_artist_tex);
		...
		String imageUrl = "https://www.artic.edu/iiif/2/" + artwork.alt_text + "/full/843,/0/default.jpg";
